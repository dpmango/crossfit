...
$(function(){if(svg4everybody(),/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?$("html").addClass("touch-device"):$("html").addClass("no-touch-device"),$("html").is(".no-touch-device")){var e=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:".nav",pushFollowers:!1,duration:0,triggerHook:0}).setClassToggle(".nav-dropdown","is-fixed").addTo(e)}$(".nav").on("click",".nav-btn",function(e){e.preventDefault(),$(this).is(".is-active")?$(this).removeClass("is-active").closest("body").removeClass("is-navOpen"):$(this).addClass("is-active").closest("body").addClass("is-navOpen")});var s='<svg class="icon-prev"><use xlink:href="/sprites/sprite.svg#icon-prev"></use></svg>',t='<svg class="icon-next"><use xlink:href="/sprites/sprite.svg#icon-next"></use></svg>';$(".program-carousel").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:[s,t],responsive:{0:{items:1},768:{items:3}}}),$(".reviews-carousel").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:[s,t],items:1}),$(".article-carousel").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:[s,t],items:1}),$(".program-tabs-menu").on("click","li:not(.active)",function(){$(this).addClass("is-active").siblings().removeClass("is-active").closest(".program-tabs").find(".program-tabs-panel").removeClass("is-active").eq($(this).index()).addClass("is-active")}),$(".js-accordion").on("click","dt",function(e){e.preventDefault(),$(this).is(".is-active")?$(this).removeClass("is-active").next("dd").slideUp("fast"):($(this).closest(".js-accordion").find("dt").removeClass("is-active").next("dd").slideUp("fast"),$(this).addClass("is-active").next("dd").slideDown("fast"))}),$(".js-mask-phone").mask("+7 (999) 999-9999"),$(".js-table-hover").on("mouseenter mouseleave","th, td",function(e){var s=this.cellIndex;$(this).closest("table").find("tr").each(function(){$(this).children().eq(s).toggleClass("is-hightlight")})}),$("[data-mfp]").magnificPopup({type:"inline",mainClass:"mfp-with-zoom",showCloseBtn:!1,removalDelay:300,zoom:{enabled:!0,duration:300,easing:"ease-in-out"},overflowY:"scroll"}),$("[data-mfp-close]").on("click",function(e){e.preventDefault(),$.magnificPopup.close()}),(new WOW).init()}),$(document).ready(function(){var e;window.initMap=function(){e=new google.maps.Map(document.getElementById("contacts-map"),{center:{lat:55.76252304,lng:37.55560935},zoom:17,mapTypeControl:!1,streetViewControl:!1,styles:[{featureType:"all",elementType:"labels.text.fill",stylers:[{saturation:36},{color:"#000000"},{lightness:40}]},{featureType:"all",elementType:"labels.text.stroke",stylers:[{visibility:"on"},{color:"#000000"},{lightness:16}]},{featureType:"all",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"administrative",elementType:"geometry.fill",stylers:[{color:"#000000"},{lightness:20}]},{featureType:"administrative",elementType:"geometry.stroke",stylers:[{color:"#000000"},{lightness:17},{weight:1.2}]},{featureType:"landscape",elementType:"geometry",stylers:[{color:"#000000"},{lightness:20}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#000000"},{lightness:21}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#000000"},{lightness:17}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#000000"},{lightness:29},{weight:.2}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#000000"},{lightness:18}]},{featureType:"road.local",elementType:"geometry",stylers:[{color:"#000000"},{lightness:16}]},{featureType:"transit",elementType:"geometry",stylers:[{color:"#000000"},{lightness:19}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#000000"},{lightness:17}]}]});new google.maps.Marker({position:{lat:55.76286,lng:37.556882},map:e,icon:"images/icon-loc.png"});e.addListener("mouseenter",function(e){return!1})}});