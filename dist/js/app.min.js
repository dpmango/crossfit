...
$(function(){!function(e,t){var o,a,s=0;for(o=0,a=e.length;o<a;o++)!function(o,a){o.onload=function(){++s==e.length&&t&&t()},o.src=a}(new Image,e[o])}(["images/bg-begin-poster.png"],function(){setTimeout(function(){$("body").addClass("pace-done"),runScrollMonitor()},500)})}),$(function(){if(svg4everybody(),/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?$("html").addClass("touch-device"):$("html").addClass("no-touch-device"),$("html").is(".no-touch-device")){var e=new ScrollMagic.Controller;new ScrollMagic.Scene({triggerElement:".nav",pushFollowers:!1,duration:0,triggerHook:0}).setClassToggle(".nav-dropdown","is-fixed").addTo(e)}$(".nav").on("click",".nav-btn",function(e){e.preventDefault(),$(this).is(".is-active")?$(this).removeClass("is-active").closest("body").removeClass("is-navOpen"):$(this).addClass("is-active").closest("body").addClass("is-navOpen")}),$('a[href^="#section"]').click(function(){var e=$(this).attr("href");return $("body, html").animate({scrollTop:$(e).offset().top-80},1e3),!1});var t=$(".nav-menu"),o=t.outerHeight()+80,a=t.find("a"),s=a.map(function(){var e=$($(this).attr("href"));if(e.length)return e});$(window).scroll(function(){var e=$(this).scrollTop()+o,t=s.map(function(){if($(this).offset().top<e)return this}),i=(t=t[t.length-1])&&t.length?t[0].id:"";a.removeClass("is-active").filter("[href='#"+i+"']").addClass("is-active")});var i='<svg class="icon-prev"><use xlink:href="/sprites/sprite.svg#icon-prev"></use></svg>',n='<svg class="icon-next"><use xlink:href="/sprites/sprite.svg#icon-next"></use></svg>';$(".program-carousel").owlCarousel({loop:!1,margin:10,nav:!0,dots:!1,navText:[i,n],autoHeight:!0,responsive:{0:{items:1},768:{items:1}}}),$(".program-carousel").on("changed.owl.carousel",function(e){e.target;var t=e.item.index+1;$(".program-tabs-menu li[data-day="+t+"]").addClass("is-active").siblings().removeClass("is-active")}),$(".program-tabs-menu").on("click","li:not(.active)",function(){var e=$(this).data("day")-1;$(".program-carousel").trigger("to.owl.carousel",[e,300])}),$(".reviews-carousel").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:[i,n],items:1,mouseDrag:!1,touchDrag:!1,freeDrag:!1}),$(".article-carousel").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:[i,n],items:1}),$(".section-carousel").owlCarousel({loop:!0,margin:10,nav:!0,dots:!1,navText:[i,n],items:1,responsive:{768:{items:3}}}),$(".about-photos").owlCarousel({loop:!0,margin:0,autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0,nav:!1,dots:!1,items:3,responsive:{768:{items:5}}}),$(".js-accordion").on("click","dt",function(e){e.preventDefault(),$(this).is(".is-active")?$(this).removeClass("is-active").next("dd").slideUp("fast"):($(this).closest(".js-accordion").find("dt").removeClass("is-active").next("dd").slideUp("fast"),$(this).addClass("is-active").next("dd").slideDown("fast"))}),$(".js-mask-phone").mask("+7 (999) 999-9999"),function(e){function t(t){var o=[];t.children("tr").each(function(t,a){e(a).children("td, th").each(function(a,s){var i,n,l=e(s),r=0|l.attr("colspan"),c=0|l.attr("rowspan");for(r=r||1,c=c||1;o[t]&&o[t][a];++a);for(i=a;i<a+r;++i)for(n=t;n<t+c;++n)o[n]||(o[n]=[]),o[n][i]=!0;var d={top:t,left:a};l.data("cellPos",d)})})}e.fn.cellPos=function(e){var o=this.first(),a=o.data("cellPos");return a&&!e||t(o.closest("table, thead, tbody, tfoot")),a=o.data("cellPos")}}(jQuery),$(".js-table-hover").on("mouseenter mouseleave","th, td",function(e){var t=$(this).cellPos().left;$(this).closest("table").find("th, td").each(function(){$(this).cellPos().left==t?$(this).addClass("is-hightlight"):$(this).removeClass("is-hightlight")})}),$(window).width()<992&&$(".js-table-hover").tableHeadFixer({left:1}),$("[data-mfp]").magnificPopup({type:"inline",mainClass:"mfp-with-zoom",showCloseBtn:!1,removalDelay:300,zoom:{enabled:!0,duration:300,easing:"ease-in-out"},overflowY:"scroll"}),$("[data-mfp-close]").on("click",function(e){e.preventDefault(),$.magnificPopup.close()}),$(".about-photos").magnificPopup({delegate:".owl-item:not(.cloned) .about-photos-item",type:"image",closeOnContentClick:!1,closeBtnInside:!1,fixedContentPos:!0,tLoading:"Загрузка #%curr%...",mainClass:"mfp-no-margins mfp-with-scale",removalDelay:300,gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1],tPrev:"Назад",tNext:"Вперед",tCounter:'<span class="mfp-counter"><span>%curr%</span> из %total%</span>'},image:{verticalFit:!0,tError:'<a href="%url%">Изображение #%curr%</a> не может быть загружено.'}});var l=!1;window.runScrollMonitor=function(){setTimeout(function(){l||(l=!0,$(".wow").each(function(e,t){var o,a=scrollMonitor.create($(t));$(window).width()<768?o=0:$(t).data("wow-delay");var s;$(t).data("animation-name")&&(s=$(t).data("animationName")),a.enterViewport(function(){$(t).addClass(s),$(t).css({"animation-name":"wowFade","animation-delay":o,visibility:"visible"})}),a.exitViewport(function(){$(t).removeClass(s),$(t).css({"animation-name":"none","animation-delay":0,visibility:"hidden"})})}))},300)},setTimeout(function(){runScrollMonitor()},1e3)}),$(document).ready(function(){var e;google.maps.event.addDomListener(window,"load",function(){e=new google.maps.Map(document.getElementById("contacts-map"),{center:{lat:55.76252304,lng:37.55560935},zoom:17,mapTypeControl:!1,streetViewControl:!1,styles:[{featureType:"all",elementType:"labels.text.fill",stylers:[{saturation:36},{color:"#000000"},{lightness:40}]},{featureType:"all",elementType:"labels.text.stroke",stylers:[{visibility:"on"},{color:"#000000"},{lightness:16}]},{featureType:"all",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"administrative",elementType:"geometry.fill",stylers:[{color:"#000000"},{lightness:20}]},{featureType:"administrative",elementType:"geometry.stroke",stylers:[{color:"#000000"},{lightness:17},{weight:1.2}]},{featureType:"landscape",elementType:"geometry",stylers:[{color:"#000000"},{lightness:20}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#000000"},{lightness:21}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#000000"},{lightness:17}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#000000"},{lightness:29},{weight:.2}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#000000"},{lightness:18}]},{featureType:"road.local",elementType:"geometry",stylers:[{color:"#000000"},{lightness:16}]},{featureType:"transit",elementType:"geometry",stylers:[{color:"#000000"},{lightness:19}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#000000"},{lightness:17}]}]});new google.maps.Marker({position:{lat:55.76286,lng:37.556882},map:e,icon:"images/icon-loc.png"});e.addListener("mouseenter",function(e){return!1})})});